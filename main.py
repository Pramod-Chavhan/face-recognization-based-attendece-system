# -*- coding: utf-8 -*-
"""
Created on Sat Jul  1 22:14:26 2023
...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        #frist Image
        img=Image.open(r"Images\img2.jfif")
        ...
        #Second Image
        img1=Image.open(r"Images\IMG1.jfif")
        ...
        #third Image
        img2=Image.open(r"Images\IMG3.jfif")
     ...
     ############################################################################################   
        ...
        #BG Image
        img3=Image.open(r"Images\BG1.jfif")
     ...
     #####################################################################################  
        ...
        #Student button       
        img4=Image.open(r"Images\BT1.jfif")
        ...
        img5=Image.open(r"Images\BT2.jfif")
        ...
        #attendence Button 3
        img6=Image.open(r"Images\BT3.jfif")
        ...
        b1_1=Button(bg_img,text="Helpdesk",cursor="hand2",command=self.Help,font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        ...
        #Face Detector button 6
        img9=Image.open(r"Images\BT6.png")
        ...
        #attendence Button 7
        img10=Image.open(r"Images\BT7.png")
        ...
        b1_1=Button(bg_img,text="Devloper",cursor="hand2",command=self.Developer,font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b1_1.place(x=800,y=600,width=220,height=40)
   

        # exit Button 8
        img11=Image.open(r"Images\BT8.png")
