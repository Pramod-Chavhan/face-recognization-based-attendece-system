# -*- coding: utf-8 -*-
"""
Created on Tue Jul  4 23:40:00 2023
...
class Attendance:
    def __init__(self, root):
        ...
        # BG Image
        img3 = Image.open(r"Images\bok.jpg")
        img3 = img3.resize((self.root.winfo_screenwidth(), self.root.winfo_screenheight()), Image.ANTIALIAS)
        ...
        main_frame.place(x=0, y=50, width=1900, height=900)

        title_lbl = Label(main_frame, text="ATTENDENCE MANAGEMENT SYSTEM", font=(
        ...
        Left_frame.place(x=5, y=50, width=730, height=580)

        img_l = Image.open(r"Images\tt.jpg")
        ...
        atten_name = ttk.Entry(left_inside_frame, width=20, textvariable=self.var_atten_name, font=(
            "times new roman", 12, "bold"))
        ...
        #attendance
        attendanceLabel = Label(left_inside_frame, text="Attendence:", font=("times new roman", 13, "bold"), bg="white")
        attendanceLabel.grid(row=3, column=0)

        self.atten_status = ttk.Combobox(left_inside_frame, width=20, textvariable=self.var_atten_attandance, font="comicsansns 11 bold", state="readonly")
        ...
        delete_btn = Button(btn_frame, text="Update", command=self.get_cursor,width=17, font=(
            "times new roman", 13, "bold"), bg="blue", fg="white")
        ...
        Right_frame.place(x=750, y=50, width=740, height=580)

        table_frame = Frame(Right_frame, bd=2, relief=RIDGE)
        table_frame.place(x=5, y=5, width=720, height=540)
